...
<head>
    ...
    <link rel="icon" href="{{ asset('film-icon.png') }}">
    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                <li>
                    <a href="{{ route('movies.index') }}" class="flex">
                        <img src="https://img.icons8.com/fluency/48/000000/movie.png"/>
                        <div class="ml-1 mt-3"> FlixDB</div>
            ...
            <div class="flex flex-col md:flex-row items-center">
                 {{-- livewire search bar dropdown menu --}}
                < livewire:search-dropdown/>
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="{{asset('alt-profile.png')}}" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
